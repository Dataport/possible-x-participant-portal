...
public class ProviderServiceImpl implements ProviderService {
    ...
    public CreateOfferResponseTO createOffer(CreateFhOfferBE createFhOfferBE, CreateEdcOfferBE createEdcOfferBE)
        ...
        FhCatalogIdResponse fhResponseId = null;
        try {
    ...
    private FhCatalogIdResponse createFhCatalogOffer(CreateFhOfferBE createFhOfferBE, String assetId) {
        ...
        FhCatalogIdResponse response = fhCatalogClient.addDatasetToFhCatalog(dataset);
