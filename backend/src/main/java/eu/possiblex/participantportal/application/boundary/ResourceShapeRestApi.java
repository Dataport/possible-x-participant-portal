...
public interface ResourceShapeRestApi {
    @Operation(summary = "Get the Gaia-X data resource shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X data resource shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X instantiated virtual resource shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X instantiated virtual resource shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X physical resource shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X physical resource shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X software resource shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X software resource shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X virtual resource shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X virtual resource shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X legitimate interest shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X legitimate interest shape as JSON string"))) })
